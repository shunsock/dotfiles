...
description: >-
  ...
  以内・1 行 70 文字以内に収め、issue/PR 番号は書かない。CONSTRAINT は REASON 行との
  句点で終わる 2 行ペアで書き、1 ファイル 3 件までに制限する。語彙は
...
- `CONSTRAINT` は `REASON` 付き 2 行ペア・句点終端・1 ファイル 3 件以内、を必ず守る。
