<!--
  ...
  ただし Closes 行は必須であり削除してはならない。
  関連 Issue が無い場合は、ユーザーに Issue の作成を案内する。
  この HTML コメントは投稿前に必ず削除する。
-->
## 概要

- [何をしたのか・何を解決するのかを 1〜2 文の箇条書きで述べる。]
- [1 項目 1 文とし、句点が出たら次の項目へ改行する。]

Closes #<issue-number>

## 背景

- [変更のきっかけとなった背景を箇条書きで記述する。]
- [例は問題の発見経緯・ユーザー報告・技術的負債である。]
- [1 項目 1 文とし、句点が出たら次の項目へ改行する。]
