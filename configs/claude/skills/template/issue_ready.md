...
[人間が実装したときの所要時間を基準に、フィボナッチ数列で見積もる。親 Issue の SP はサブイシューの SP の合計とする。]
...
| 5 | 2〜3 日 |
| 8 | 1 週間 — サブイシュー分割を推奨 |
| 13 | 分割必須。この粒度の Issue を ready にしない |

- 親 Issue 合計: [N] SP

## サブイシュー一覧

[1 PR で完結する粒度 (3 SP 以下) に分割したサブイシューを列挙する。依存関係と並行可否が分かるようにする。]
